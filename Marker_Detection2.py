...
parser.add_argument('--image', help=r"C:\Users\21zeymou\Documents\OneNote Notebooks\Augmented Reality\marker33.png")
parser.add_argument('--video', help='Path to video file.')
args = parser.parse_args()

im_src = cv.imread("new_scenery.jpg");

outputFile = r"C:\Users\21zeymou\Documents\OneNote Notebooks\Augmented Reality\ar_out_py.avi"
if (args.image):
    # Open the image file
